...
@PrepareForTest(PermissionChecker::class, ConductorControllerWithAllAnnotations::class, AppOpsManagerCompat::class, Process::class)
class ConductorControllerWithAllAnnotationsPermissionsDispatcherTest {

    private lateinit var controller: ConductorControllerWithAllAnnotations
    ...
    @Before
    fun setUp() {
        controller = PowerMockito.mock(ConductorControllerWithAllAnnotations::class.java)
    ...
    fun `already granted call the method`() {
        ...
        ConductorControllerWithAllAnnotationsPermissionsDispatcher.showCameraWithPermissionCheck(controller)
    ...
    fun `the method is called if verifyPermission is true`() {
        ConductorControllerWithAllAnnotationsPermissionsDispatcher.onRequestPermissionsResult(controller, requestCode, intArrayOf(PackageManager.PERMISSION_GRANTED))
    ...
    fun `the method is not called if verifyPermission is false`() {
        ConductorControllerWithAllAnnotationsPermissionsDispatcher.onRequestPermissionsResult(controller, requestCode, intArrayOf(PackageManager.PERMISSION_DENIED))
    ...
    fun `no the method call if request code is not related to the library`() {
        ConductorControllerWithAllAnnotationsPermissionsDispatcher.onRequestPermissionsResult(controller, requestCode + 1000, null)
