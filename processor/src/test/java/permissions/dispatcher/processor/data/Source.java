    ...
    public static final BaseTest OnePermissionActivity = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "   }",
                    "   static void showCameraWithPermissionCheck(MyActivity target) {",
    ...
    public static final BaseTest TwoPermissionsWithNeverAskActivity = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "       }",
                    "   }",
                    "   static void accessContactsWithPermissionCheck(MyActivity target) {",
                    "       if (target == null) return;",
    ...
    public static final BaseTest TwoPermissionsSupportFragment = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "       }",
                    "   }",
                    "   static void accessContactsWithPermissionCheck(MyFragment target) {",
                    "       if (target == null) return;",
                    "       Activity activity = target.getActivity();",
                    "       if (activity == null) return;",
    ...
    public static final BaseTest TwoPermissionsWithSameSignatureActivity = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "       }",
                    "   }",
                    "   static void showCamera2WithPermissionCheck(MyActivity target) {",
                    "       if (target == null) return;",
    ...
    public static final BaseTest OnePermissionWithParametersSupportFragment = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "   private  MyFragmentPermissionsDispatcher() {",
                    "   }",
                    "   static void showCameraWithPermissionCheck(MyFragment target, int value, String name) {",
                    "       if (target == null) return;",
                    "       Activity activity = target.getActivity();",
                    "       if (activity == null) return;",
                    "       if (PermissionUtils.hasSelfPermissions(activity, PERMISSION_SHOWCAMERA)) {",
    ...
    public static final BaseTest TwoPermissionsWithSameSignatureSupportFragment = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "       }",
                    "   }",
                    "   static void showCamera2WithPermissionCheck(MyFragment target) {",
                    "       if (target == null) return;",
                    "       Activity activity = target.getActivity();",
                    "       if (activity == null) return;",
    ...
    public static final BaseTest NoDuplicatesDespiteRepeatedValuesActivity = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "       }",
                    "   }",
                    "   static void showGetStorageWithPermissionCheck(MyActivity target) {",
                    "       if (target == null) return;",
    ...
    public static final BaseTest WriteSettingsSupportFragment = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "    Activity activity = target.getActivity();",
                    "    if (activity == null) return;",
                    "    if (PermissionUtils.hasSelfPermissions(activity, PERMISSION_WRITESETTINGS) || Settings.System.canWrite(activity)) {",
    ...
    public static final BaseTest SystemAlertWindowSupportFragment = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "  private MyFragmentPermissionsDispatcher() {",
                    "  }",
                    "  static void systemAlertWindowWithPermissionCheck(MyFragment target) {",
                    "    if (target == null) return;",
                    "    Activity activity = target.getActivity();",
                    "    if (activity == null) return;",
                    "    if (PermissionUtils.hasSelfPermissions(activity, PERMISSION_SYSTEMALERTWINDOW) || Settings.canDrawOverlays(activity)) {",
    ...
    public static final BaseTest WriteSettingsActivity = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "  private MyActivityPermissionsDispatcher() {",
                    "  }",
                    "  static void writeSettingsWithPermissionCheck(MyActivity target) {",
                    "    if (target == null) return;",
    ...
    public static final BaseTest SystemAlertWindowActivity = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "  private MyActivityPermissionsDispatcher() {",
                    "  }",
                    "  static void systemAlertWindowWithPermissionCheck(MyActivity target) {",
                    "    if (target == null) return;",
    ...
    public static final BaseTest SystemAlertWindowSupportGenericsFragment = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "  private MyFragmentPermissionsDispatcher() {",
                    "  }",
                    "  static <T, U extends Integer, V extends Map<? extends Annotation, ?>> void systemAlertWindowWithPermissionCheck(MyFragment<T, U, V> target) {",
                    "    if (target == null) return;",
                    "    Activity activity = target.getActivity();",
                    "    if (activity == null) return;",
                    "    if (PermissionUtils.hasSelfPermissions(activity, PERMISSION_SYSTEMALERTWINDOW) || Settings.canDrawOverlays(activity)) {",
    ...
    public static final BaseTest SystemAlertWindowGenericsActivity = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "  private MyActivityPermissionsDispatcher() {",
                    "  }",
                    "  static <T, U extends Integer, V extends Map<? extends Annotation, ?>> void systemAlertWindowWithPermissionCheck(MyActivity<T, U, V> target) {",
                    "    if (target == null) return;",
                    "    if (PermissionUtils.hasSelfPermissions(target, PERMISSION_SYSTEMALERTWINDOW) || Settings.canDrawOverlays(target)) {",
                    "      target.systemAlertWindow();",
                    "    } else {",
    ...
    public static final BaseTest NestedActivity = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "   private MyActivityPermissionsDispatcher() {",
                    "   }",
                    "   static void showCameraWithPermissionCheck(Foo.Bar.MyActivity target) {",
                    "       if (target == null) return;",
                    "       if (PermissionUtils.hasSelfPermissions(target, PERMISSION_SHOWCAMERA)) {",
                    "           target.showCamera();",
                    "       } else {",
    ...
    public static final BaseTest NestedStaticActivity = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "   private MyActivityPermissionsDispatcher() {",
                    "   }",
                    "   static void showCameraWithPermissionCheck(Foo.MyActivity target) {",
                    "       if (target == null) return;",
                    "       if (PermissionUtils.hasSelfPermissions(target, PERMISSION_SHOWCAMERA)) {",
                    "           target.showCamera();",
                    "       } else {",
    ...
    public static final BaseTest NestedFragment = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "   private  MyFragmentPermissionsDispatcher() {",
                    "   }",
                    "   static void showCameraWithPermissionCheck(Foo.MyFragment target) {",
                    "       if (target == null) return;",
                    "       Activity activity = target.getActivity();",
                    "       if (activity == null) return;",
                    "       if (PermissionUtils.hasSelfPermissions(activity, PERMISSION_SHOWCAMERA)) {",
