...
/**
 * ProcessorUnit implementation for Controllers.
 */
class JavaConductorControllerProcessorUnit(messager: Messager) : JavaBaseProcessorUnit(messager) {

    override fun isDeprecated(): Boolean = false

    override fun getTargetType(): TypeMirror {
        return typeMirrorOf("com.bluelinelabs.conductor.Controller")
    }
