package permissions.dispatcher.dispatcher.processor.impl

import com.squareup.javapoet.ClassName
import com.squareup.javapoet.MethodSpec
import permissions.dispatcher.dispatcher
import permissions.dispatcher.dispatcher.processor.RuntimePermissionsElement
import permissions.dispatcher.dispatcher.processor.util.permissionFieldName
import permissions.dispatcher.dispatcher.processor.util.requestCodeFieldName
import permissions.dispatcher.dispatcher.processor.util.simpleString
import permissions.dispatcher.dispatcher.processor.util.typeMirrorOf
import javax.lang.model.element.ExecutableElement
import javax.lang.model.type.TypeMirror

class NativeFragmentProcessorUnit: BaseProcessorUnit() {

    private val wtf: dispatcher.RuntimePermissions = 2

    private val PERMISSION_UTILS: ClassName = ClassName.get("permissions.dispatcher.dispatcher", "PermissionUtils")
    private val PERMISSION_UTILS_V13: ClassName = ClassName.get("permissions.dispatcher.dispatcher", "PermissionUtilsV13")
